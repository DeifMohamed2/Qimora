/* ============================================================
   ...
   Inline styles are primary; <style> augments dark mode where supported.
   ============================================================ */
...
function brandHeaderHtml(logoImgSrc, siteUrl) {
  ...
  return `<tr>
  <td class="eb-header-wrap" style="padding:0;margin:0;background:linear-gradient(145deg,#2a3f7a 0%,#1e2d52 38%,#161d27 100%);border-radius:16px 16px 0 0;border:1px solid #33486e;border-bottom:none;">
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
      <tr>
        <td align="center" style="padding:32px 22px 26px;">
          ...
          <p class="eb-tagline" style="margin:0 0 8px;font-family:'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:11px;font-weight:700;letter-spacing:0.22em;text-transform:uppercase;color:#b8cff5;">Build once · Scale fast</p>
          <p style="margin:0;font-family:'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:13px;font-weight:600;">
            <a href="${home}" class="eb-text-link" style="color:#93c5fd;text-decoration:none;border-bottom:1px solid rgba(147,197,253,0.35);">qimora.io</a>
          </p>
        </td>
      </tr>
    </table>
...
function brandFooterHtml(siteUrl) {
  return `<tr>
  <td class="eb-footer" style="padding:22px 24px 26px;background:#121820;border:1px solid #2d3f5c;border-top:none;border-radius:0 0 16px 16px;text-align:center;">
    <p style="margin:0 0 8px;font-family:'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:12px;color:#7a8ca8;line-height:1.55;">
      <a href="mailto:info@qimora.io" class="eb-footer-link" style="color:#8eb4ff;text-decoration:none;">info@qimora.io</a>
      <span style="color:#4a5a72;"> &nbsp;·&nbsp; </span>
      <a href="https://wa.me/201156012078" class="eb-footer-link" style="color:#8eb4ff;text-decoration:none;">WhatsApp</a>
    </p>
    <p style="margin:0;font-family:'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:11px;color:#5c6b82;line-height:1.5;">
      <a href="${attrSafe(siteUrl)}/" class="eb-footer-muted" style="color:#6b86c4;text-decoration:none;">Visit website</a>
      <span style="color:#4a5a72;"> · </span>
...
function emailStylesBlock() {
  return `<style type="text/css">
    ...
    [data-ogsc] .eb-footer { background-color: #020617 !important; }
  </style>`;
}
...
<body class="eb-body" style="margin:0;padding:0;background-color:#0a0e14;">
  <table role="presentation" class="eb-outer" width="100%" cellspacing="0" cellpadding="0" style="background-color:#0a0e14;padding:28px 12px;">
    <tr>
      <td align="center">
        <table role="presentation" width="100%" style="max-width:600px;border-collapse:collapse;">
          ${brandHeaderHtml(logoImgSrc, siteUrl)}
          <tr>
            <td class="eb-card" style="padding:28px 26px 28px;background-color:#161d27;border-left:1px solid #2d3f5c;border-right:1px solid #2d3f5c;border-bottom:1px solid #2d3f5c;">
              ${mainInnerHtml}
            </td>
          </tr>
