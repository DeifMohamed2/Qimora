/* ============================================================
   ...
   Header uses one fixed “brand” look (dark blue gradient) in all themes.
   Body card + footer: light inline defaults; dark via prefers-color-scheme + [data-ogsc].
   ============================================================ */
...
function brandHeaderHtml(logoImgSrc, siteUrl) {
  ...
  return `<tr>
  <td class="eb-header-wrap" style="padding:0;margin:0;background:linear-gradient(155deg,#1d4ed8 0%,#1e3a8a 42%,#0f172a 100%);border-radius:16px 16px 0 0;border:1px solid #334155;border-bottom:none;">
