...
function meetingReceivedHtml(booking, siteUrl, logoImgSrc) {
  const inner = `
<h1 style="margin:0 0 12px;font-size:21px;line-height:1.3;color:#0f172a;font-weight:700;">Meeting request received</h1>
<p style="margin:0 0 20px;color:#475569;font-size:15px;line-height:1.65;">
  Hi ${esc(booking.name)}, thank you for choosing a time with Qimora. Your request is <strong style="color:#0f172a;">pending confirmation</strong> from our side.
</p>
...
<p style="margin:0;color:#475569;font-size:14px;line-height:1.65;">
  Once we confirm your slot, you’ll receive a follow-up email with a <strong style="color:#0f172a;">Google Meet</strong> link and final details. If anything changes, we’ll reach out at <strong style="color:#0f172a;">${esc(booking.email)}</strong>.
</p>
<p style="margin:22px 0 0;font-size:14px;color:#475569;">Best,<br /><strong style="color:#0f172a;">Qimora</strong></p>
`;
